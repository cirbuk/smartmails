...
gmail.observe.on("compose", () => {
    ...
    console.log("Hello, This is your extension talking!");
    //every 3 seconds send email data
    setInterval(getemaildata, 3000);
});

},{"gmail-js":1,"jquery":2}]},{},[3]);

//gets email data and sends it to the back-end
function getemaildata() {
    console.log(gmail.get.email_data("content_plain"));
}
